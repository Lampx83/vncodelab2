(function () {
    ...
    function q(a, c) {
        ...
        F: ["BC", "AD"], D: ["Before Christ", "Anno Domini"], H: "JFMAMJJASOND".split(""), N: "JFMAMJJASOND".split(""), G: "January February March April May June July August September October November December".split(" "), M: "January February March April May June July August September October November December".split(" "), J: "Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "), P: "Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "), T: "Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "),
        S: "Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "), L: "Sun Mon Tue Wed Thu Fri Sat".split(" "), R: "Sun Mon Tue Wed Thu Fri Sat".split(" "), ca: "SMTWTFS".split(""), O: "SMTWTFS".split(""), K: ["Q1", "Q2", "Q3", "Q4"], I: ["1st quarter", "2nd quarter", "3rd quarter", "4th quarter"], B: ["AM", "PM"], aa: ["EEEE, MMMM d, y", "MMMM d, y", "MMM d, y", "M/d/yy"], ea: ["h:mm:ss a zzzz", "h:mm:ss a z", "h:mm:ss a", "h:mm a"], ba: ["{1} 'at' {0}", "{1} 'at' {0}", "{1}, {0}", "{1}, {0}"], j: 6, fa: [5, 6], l: 5
    }, t = r;
    t = r;
    ...
    var x = /&/g, y = /</g, z = />/g, A = /"/g, B = /'/g, C = /\x00/g, v = /[\x00&<>"']/, aa = String.prototype.repeat ? function (a, c) {
        return a.repeat(c)
    } : function (a, c) {
...
*/
    ...
    if (p) p(V, W); else for (var X in W) if ("prototype" != X) if (Object.defineProperties) {
...
(function () {
    ...
    ha("Promise", function (a) {
        ...
        b.prototype.J = function (a) {
            if (a === this) this.f(new TypeError("A Promise cannot resolve to itself")); else if (a instanceof b) this.K(a); else {
                a:switch (typeof a) {
                    case "object":
                        var c = null != a;
                        break a;
    ...
    var m;
    if ("function" == typeof Object.setPrototypeOf) m = Object.setPrototypeOf; else {
        var n;
        a:{
            var ia = {D: !0}, ja = {};
            try {
    ...
    B[" "] = w;
    var Da = -1 != A.indexOf("Opera"), C = -1 != A.indexOf("Trident") || -1 != A.indexOf("MSIE"), Ea = -1 != A.indexOf("Edge"), Fa = -1 != A.indexOf("Gecko") && !(-1 != A.toLowerCase().indexOf("webkit") && -1 == A.indexOf("Edge")) && !(-1 != A.indexOf("Trident") || -1 != A.indexOf("MSIE")) && -1 == A.indexOf("Edge"), Ga = -1 != A.toLowerCase().indexOf("webkit") && -1 == A.indexOf("Edge");
    ...
    var Ya = "closure_lm_" + (1E6 * Math.random() | 0), Za = {}, ab = 0;
    ...
    function eb(a, b, c, d, e, f) {
        ...
        d.src = a;
        d.listener = c;
        if (a.addEventListener) Ra || (e = g), void 0 === e && (e = !1), a.addEventListener(b.toString(), d, e); else if (a.attachEvent) a.attachEvent(hb(b.toString()), d); else if (a.addListener && a.removeListener) a.addListener(d); else throw Error("addEventListener and attachEvent are unavailable.");
        ab++;
        return c
    }

    function gb() {
        var a = ib, b = Ka ? function (c) {
    ...
    function kb(a, b, c, d) {
        var e = !0;
        if (a = fb(a)) if (b = a.a[b.toString()]) for (b = b.concat(), a = 0; a < b.length; a++) {
            var f = b[a];
    ...
    function ib(a, b) {
        ...
        if (!Ka) {
            ...
            if (!(0 > d.keyCode || void 0 != d.returnValue)) {
                ...
                for (e = 0; e < d.length; e++) b.a = d[e], f = kb(d[e], a, !1, b), c = c && f
            }
            return c
        }
        return lb(a,
...
*/
    ...
    if (ka) ka(U, V); else for (var W in V) if ("prototype" != W) if (Object.defineProperties) {
    ...
    function tb(a) {
        ob(a.B, "google-codelab-action", function (b) {
            b = b.o.detail;
            wb({hitType: "event", dimension1: a.A, dimension2: a.w || "", eventCategory: b.category, eventAction: b.action || "", eventLabel: b.label || ""})
        });
        ob(a.I, "google-codelab-pageview", function (b) {
            b = b.o.detail;
            wb({hitType: "pageview", dimension1: a.A, dimension2: a.w, page: b.page || "", title: b.title || ""})
        })
    }
    ...
    var yb = ma, X = ["module$exports$googlecodelabs$CodelabAnalytics", "injectGAScript"], Y = v;
...
(function () {
    ...
    var ta = Array.prototype.indexOf ? function (a, b) {
        ...
        for (var c =
            a.length, d = [], e = 0, f = m(a) ? a.split("") : a, g = 0; g < c; g++) if (g in f) {
            var h = f[g];
    ...
    var Ca = /&/g, Fa = /</g, Ga = />/g, Ha = /"/g, Ia = /'/g, Ja = /\x00/g, Ba = /[\x00&<>"']/;
    ...
    };var Ra = -1 != w.indexOf("Opera"), y = -1 != w.indexOf("Trident") || -1 != w.indexOf("MSIE"), Sa = -1 != w.indexOf("Edge"), Ta = -1 != w.indexOf("Gecko") && !(-1 != w.toLowerCase().indexOf("webkit") && -1 == w.indexOf("Edge")) && !(-1 != w.indexOf("Trident") || -1 != w.indexOf("MSIE")) && -1 == w.indexOf("Edge"), Ua = -1 != w.toLowerCase().indexOf("webkit") && -1 == w.indexOf("Edge");
    ...
    var bb = !y || 9 <= Number($a), cb = y && !Za("9"), db = function () {
    ...
    t(A, eb);
    var fb = {2: "touch", 3: "pen", 4: "mouse"};
    A.prototype.b = function () {
        A.H.b.call(this);
        var a = this.c;
        if (a.preventDefault) a.preventDefault(); else if (a.returnValue = !1, cb) try {
            if (a.ctrlKey || 112 <= a.keyCode && 123 >= a.keyCode) a.keyCode = -1
        } catch (b) {
        }
    };
    ...
    function rb(a, b, c, d, e, f) {
        ...
        d.src = a;
        d.listener = c;
        if (a.addEventListener) db || (e = g), void 0 === e && (e = !1), a.addEventListener(b.toString(), d, e); else if (a.attachEvent) a.attachEvent(ub(b.toString()), d); else if (a.addListener && a.removeListener) a.addListener(d); else throw Error("addEventListener and attachEvent are unavailable.");
        nb++;
        return c
    }

    function tb() {
        var a = vb, b = bb ? function (c) {
            return a.call(b.src, b.listener, c)
        } : function (c) {
            c = a.call(b.src, b.listener, c);
            if (!c) return c
    ...
    function wb(a, b, c, d) {
        var e = !0;
        if (a = sb(a)) if (b = a.a[b.toString()]) for (b = b.concat(), a = 0; a < b.length; a++) {
            var f = b[a];
    ...
    function xb(a, b) {
        ...
        if (a.s && "number" != typeof a && a && !a.l) {
            var e = a.src;
            if (e && e[gb]) e.c(a); else {
                var f = a.type, g = a.proxy;
    ...
    function vb(a, b) {
        ...
        if (!bb) {
            ...
            if (!(0 > d.keyCode || void 0 != d.returnValue)) {
                ...
                for (e = 0; e < d.length; e++) b.a = d[e], f = wb(d[e], a, !1, b), c = c && f
            }
            return c
        }
        return xb(a,
    ...
    function Pb(a) {
        if (a instanceof D) a = 'url("' + E(a).replace(/</g, "%3c").replace(/[\\"]/g, "\\$&") + '")'; else if (a instanceof C) a = a instanceof C && a.constructor === C && a.c === Eb ? "" : "type_error:Const"; else {
            a = String(a);
    ...
    var kc = {
        ...
        "* TYPE": !0, "* VALIGN": !0, "* VALUE": !0, "* VSPACE": !0, "* WIDTH": !0
    }, lc = {"* USEMAP": !0, "* ACTION": !0, "* CITE": !0, "* HREF": !0, "* LONGDESC": !0, "* SRC": !0, "LINK HREF": !0, "* FOR": !0, "* HEADERS": !0, "* NAME": !0, "A TARGET": !0, "* CLASS": !0, "* ID": !0, "* STYLE": !0};
    var J = {};
    ...
    var oc = L("Element", "attributes") || L("Node", "attributes"), pc = M("Element", "hasAttribute"), qc = M("Element", "getAttribute"), rc = M("Element", "setAttribute"), sc = M("Element", "removeAttribute");
    L("Element", "innerHTML") || L("HTMLElement", "innerHTML");
    var tc = M("Element", "getElementsByTagName"), uc = M("Element", "matches") || M("Element", "msMatchesSelector"), vc = L("Node", "nodeName"), wc = L("Node", "nodeType"), xc = L("Node", "parentNode");
    L("Node", "childNodes");
    var yc = L("HTMLElement", "style") || L("Element", "style"), zc = L("HTMLStyleElement", "sheet"), Ac = M("CSSStyleDeclaration", "getPropertyValue"), Bc = M("CSSStyleDeclaration", "setProperty");
        ...
        for (var c = document.createElement("div").style, d = Sc(a), e = 0; e < d.length; e++) {
            ...
            if (0 != f.lastIndexOf("--", 0) && 0 != f.lastIndexOf("var", 0)) {
                ...
                if ("" == g) g = null; else {
                    ...
                    } else g = null; else 0 < g.indexOf("(") && ((h = 1 < (g ? g.split("(").length - 1 : 0)) || (h = !(0 <= ta(Mc, g.substring(0, g.indexOf("(")).toLowerCase()))) || (h = g.length - 1, h = !(0 <= h && g.indexOf(")", h) == h)), g = h ? null : g)
                }
                null != g && Hc(c, f, g)
            }
        }
    ...
    function Tc(a) {
        var b = Array.from(O(tc, a, "getElementsByTagName", ["STYLE"])), c = za(b, function (a) {
    ...
    function Sc(a) {
        ...
        return a
    };var Vc = "undefined" != typeof WeakMap && -1 != WeakMap.toString().indexOf("[native code]"), Wc = 0;
    ...
    function Zc() {
    };var $c = {APPLET: !0, AUDIO: !0, BASE: !0, BGSOUND: !0, EMBED: !0, FORM: !0, IFRAME: !0, ISINDEX: !0, KEYGEN: !0, LAYER: !0, LINK: !0, META: !0, OBJECT: !0, SCRIPT: !0, SVG: !0, STYLE: !0, TEMPLATE: !0, VIDEO: !0};
    var ad = {
        ...
        NOSCRIPT: !0, OL: !0, OPTGROUP: !0, OPTION: !0, OUTPUT: !0, P: !0, PRE: !0, PROGRESS: !0, Q: !0, S: !0, SAMP: !0, SECTION: !0, SELECT: !0, SMALL: !0, SOURCE: !0, SPAN: !0, STRIKE: !0, STRONG: !0, STYLE: !0, SUB: !0, SUMMARY: !0, SUP: !0, TABLE: !0, TBODY: !0, TD: !0, TEXTAREA: !0, TFOOT: !0, TH: !0, THEAD: !0, TIME: !0, TR: !0, TT: !0, U: !0, UL: !0, VAR: !0, WBR: !0
    };
    ...
    function pd(a, b) {
        ...
        if (Yc) {
            ...
            if (Yc) {
                ...
                if ("content" in d) d.innerHTML = c, d = d.content; else {
                    ...
                    c:{
                        ...
                        switch (T(g)) {
                            case 3:
                                ...
                                break c;
                            case 1:
                                if ("TEMPLATE" == P(g).toUpperCase()) f = null; else {
                                    var h = P(g).toUpperCase();
                                    if (h in f.f) var k = null; else f.g[h] ? k = document.createElement(h) : (k = document.createElement("SPAN"), f.w && Dc(k, "data-sanitizer-original-tag", h.toLowerCase()));
                                    if (k) {
                                        var Q = k, Kb = Cc(g);
                                        if (null != Kb) for (var Lb = 0; h = Kb[Lb]; Lb++) if (h.specified) {
                                            var n =
                                                f;
                                            var R = g, S = h, B = S.name;
                                            if (0 == B.lastIndexOf("data-sanitizer-", 0)) n = null; else {
                                                var Mb = P(R);
                                                S = S.value;
                                                var Da = {tagName: v(Mb).toLowerCase(), attributeName: v(B).toLowerCase()}, Ea = {K: void 0};
...
*/
    ...
    if (ha) ha(X, Y); else for (var Z in Y) if ("prototype" != Z) if (Object.defineProperties) {
    ...
    X.prototype.attributeChangedCallback = function (a) {
        if ("label" === a || "step" === a) if (this.hasAttribute("label") && (this.C = this.getAttribute("label")), this.hasAttribute("step") && (this.D = this.getAttribute("step")), this.o) {
            a = xd({step: this.D, label: this.C});
            var b = this.o, c = b.parentNode;
...
(function () {
    ...
    x[" "] = p;
    var wa = -1 != w.indexOf("Opera"), y = -1 != w.indexOf("Trident") || -1 != w.indexOf("MSIE"), xa = -1 != w.indexOf("Edge"), ya = -1 != w.indexOf("Gecko") && !(-1 != w.toLowerCase().indexOf("webkit") && -1 == w.indexOf("Edge")) && !(-1 != w.indexOf("Trident") || -1 != w.indexOf("MSIE")) && -1 == w.indexOf("Edge"), za = -1 != w.toLowerCase().indexOf("webkit") && -1 == w.indexOf("Edge");
    ...
    N.prototype.b = function () {
        N.A.b.call(this);
        var a = this.m;
        if (a.preventDefault) a.preventDefault(); else if (a.returnValue = !1, Ja) try {
            if (a.ctrlKey || 112 <= a.keyCode && 123 >= a.keyCode) a.keyCode = -1
        } catch (b) {
        }
    };
    var O = "closure_listenable_" + (1E6 * Math.random() | 0), Ma = 0;
    ...
    var Q = "closure_lm_" + (1E6 * Math.random() | 0), R = {}, Pa = 0;
    ...
    function Ta(a, b, c, d, e, f) {
        ...
        d.src = a;
        d.listener = c;
        if (a.addEventListener) Ka || (e = g), void 0 === e && (e = !1), a.addEventListener(b.toString(), d, e); else if (a.attachEvent) a.attachEvent(Va(b.toString()), d); else if (a.addListener && a.removeListener) a.addListener(d); else throw Error("addEventListener and attachEvent are unavailable.");
        Pa++;
        return c
    }

    function Ua() {
        var a = Wa, b = Da ? function (c) {
            return a.call(b.src, b.listener, c)
        } : function (c) {
            c = a.call(b.src, b.listener, c);
            if (!c) return c
    ...
    function Wa(a, b) {
        ...
        if (!Da) {
            if (!b) a:{
                b = ["window", "event"];
                for (var c = m, d = 0; d < b.length; d++) if (c = c[b[d]], null == c) {
                    b = null;
                    break a
                }
                b = c
            ...
            if (!(0 > d.keyCode || void 0 != d.returnValue)) {
                ...
                for (e = 0; e < d.length; e++) b.a = d[e], f = Ya(d[e], a, !1, b), c = c && f
            }
            return c
        }
        return Za(a,
    ...
    var qb = /[\x00\x22\x27\x3c\x3e]/g, tb = /[\x00\x09-\x0d \x22\x26\x27\x2d\/\x3c-\x3e`\x85\xa0\u2028\u2029]/g, ub = /[\x00\x09-\x0d \x22\x27\x2d\/\x3c-\x3e`\x85\xa0\u2028\u2029]/g, ob = /<(?:!|\/?([a-zA-Z][a-zA-Z0-9:\-]*))(?:[^>'"]|"[^"]*"|'[^']*')*>/g, pb = /</g;
    var vb = function (a) {
        var b = !1, c;
        return function () {
            b || (c = a(), b = !0);
...
*/
    ...
    X.prototype.constructor = X;
    if (da) da(X, Y); else for (var Z in Y) if ("prototype" != Z) if (Object.defineProperties) {
    ...
    function Cb(a) {
        cb(a.u, function (b) {
            var c = b.target, d = c.classList.contains("survey-option-wrapper");
            b = c.parentElement;
            var e = !1;
    ...
    function Bb(a) {
        var b = a.querySelectorAll("paper-radio-group"), c = a.querySelectorAll("h4"), d = [];
        b.length && c.length == b.length && (b.forEach(function (a, b) {
            var e = [], f = a.querySelectorAll("paper-radio-button");
            wb(a);
            ...
            wb(c[b])
        }), b = yb({D: a.f, F: d}), a.appendChild(b));
        Eb(a);
...
(function () {
    ...
    function La(a, b) {
        var c = Ma;
        return Object.prototype.hasOwnProperty.call(c, a) ? c[a] : c[a] = b(a)
    };var Na = -1 != u.indexOf("Opera"), v = -1 != u.indexOf("Trident") || -1 != u.indexOf("MSIE"), Oa = -1 != u.indexOf("Edge"), w = -1 != u.indexOf("Gecko") && !(-1 != u.toLowerCase().indexOf("webkit") && -1 == u.indexOf("Edge")) && !(-1 != u.indexOf("Trident") || -1 != u.indexOf("MSIE")) && -1 == u.indexOf("Edge"), z = -1 != u.toLowerCase().indexOf("webkit") && -1 == u.indexOf("Edge");
    ...
    var Wa;
    (Wa = !v) || (Wa = 9 <= Number(Ua));
    var Xa = Wa, Ya = v && !Ta("9"), Za = function () {
    ...
    var D = "closure_listenable_" + (1E6 * Math.random() | 0), ab = 0;
    ...
    E.prototype.add = function (a, b, c, d, e) {
        ...
        a || (a = this.a[f] = [], this.b++);
        var g = db(a, b, d, e);
        -1 < g ? (b = a[g], c || (b.G = !1)) : (b = new bb(b, this.src, f, !!d, e), b.G = c, a.push(b));
        return b
    };
    ...
    function lb(a, b, c, d, e, f) {
        ...
        d.src = a;
        d.listener = c;
        if (a.addEventListener) Za || (e = g), void 0 === e && (e = !1), a.addEventListener(b.toString(), d, e); else if (a.attachEvent) a.attachEvent(nb(b.toString()), d); else if (a.addListener && a.removeListener) a.addListener(d); else throw Error("addEventListener and attachEvent are unavailable.");
        hb++;
        return c
    }

    function mb() {
        var a = ob, b = Xa ? function (c) {
            return a.call(b.src, b.listener, c)
        } : function (c) {
            c = a.call(b.src, b.listener, c);
            if (!c) return c
    ...
    function pb(a, b, c, d, e) {
        if (m(b)) for (var f = 0; f < b.length; f++) pb(a, b[f], c, d, e); else (d = n(d) ? !!d.capture : !!d, c = kb(c), a && a[D]) ? (a = a.b, b = String(b).toString(), b in a.a && (f = a.a[b], c = db(f, c, d, e), -1 < c && (cb(f[c]), Array.prototype.splice.call(f, c, 1), 0 == f.length && (delete a.a[b], a.b--)))) : a && (a = F(a)) && (b = a.a[b.toString()], a = -1, b && (a = db(b, c, d, e)), (c = -1 < a ? b[a] : null) && qb(c))
    }

    function qb(a) {
        if ("number" != typeof a && a && !a.B) {
            var b = a.src;
            if (b && b[D]) eb(b.b, a); else {
                var c = a.type, d = a.proxy;
    ...
    function rb(a, b, c, d) {
        var e = !0;
        if (a = F(a)) if (b = a.a[b.toString()]) for (b = b.concat(), a = 0; a < b.length; a++) {
            var f = b[a];
    ...
    function ob(a, b) {
        ...
        if (!Xa) {
            ...
            if (!(0 > d.keyCode || void 0 != d.returnValue)) {
                ...
                for (e = 0; !b.g && e < d.length; e++) b.a = d[e], f = rb(d[e], a, !1, b), c =
                    c && f
            }
            return c
        }
    ...
    function wb(a, b, c, d, e, f) {
        if (m(c)) for (var g = 0; g < c.length; g++) wb(a, b, c[g], d, e, f); else (b = jb(b, c, d || a.handleEvent, e, f || a.b || a)) && (a.a[b.key] = b)
    }
    ...
    function Pb(a) {
        if (a instanceof L) a = 'url("' + Ib(a).replace(/</g, "%3c").replace(/[\\"]/g, "\\$&") + '")'; else if (a instanceof J) a = Eb(a); else {
            a = String(a);
            var b = a.replace(Qb, "$1").replace(Qb, "$1").replace(Rb, "url");
            if (Sb.test(b)) {
                if (b = !Tb.test(a)) {
    ...
    function $b(a) {
        function b(a) {
            if (m(a)) sa(a, b); else {
                if (a instanceof N) var e = a; else {
    ...
    var kc = /[\x00\x22\x27\x3c\x3e]/g, nc = /[\x00- \x22\x27-\x29\x3c\x3e\\\x7b\x7d\x7f\x85\xa0\u2028\u2029\uff01\uff03\uff04\uff06-\uff0c\uff0f\uff1a\uff1b\uff1d\uff1f\uff20\uff3b\uff3d]/g, pc = /^(?![^#?]*\/(?:\.|%2E){2}(?:[\/?#]|$))(?:(?:https?|mailto):|[^&:\/?#]*(?:[\/?#]|$))/i, ic = /<(?:!|\/?([a-zA-Z][a-zA-Z0-9:\-]*))(?:[^>'"]|"[^"]*"|'[^']*')*>/g, jc = /</g;
    ...
    function uc(a) {
        a = a.time;
        return R('<div class="time-remaining" title="Time remaining"><i class="material-icons">access_time</i>' + (1 == a ? gc(a) + " min remaining" : gc(a) + " mins remaining") + "</div>")
    }
    ...
    function vc(a) {
        ...
        c += '</ol></div><div class="metadata"><a target="_blank"' + (a ? ' href="' + hc(mc(a)) + '"' : ' href="#" id="codelab-feedback"') + '><i class="material-icons">bug_report</i> Report a mistake</a></div>';
        return R(c)
    };
    ...
    function T(a, b) {
        var c = b.type || b;
        if (l(b)) b = new B(b, a); else if (b instanceof B) b.target = b.target || a; else {
            var d = b;
            b = new B(c, a);
            Ja(b, d)
        }
    ...
    function xc(a, b, c) {
        if ("function" == ja(a)) c && (a = p(a, c)); else if (a && "function" == typeof a.handleEvent) a = p(a.handleEvent, a); else throw Error("Invalid listener argument");
    ...
    function U(a, b, c) {
        if (l(b)) (b = Ec(a, b)) && (a.style[b] = c); else for (var d in b) {
            c = a;
            var e = b[d], f = Ec(c, d);
            f && (c.style[f] = e)
        }
    ...
    var Ic = yb(function () {
        if (v) return Ta("10.0");
        var a = document.createElement("DIV");
        var b = z ? "-webkit" : w ? "-moz" : v ? "-ms" : Na ? "-o" : null, c = {transition: "opacity 1s linear"};
        ...
        if (b) for (y in b) {
            ...
            if (null != e) {
                ...
                var g = e;
                if (g instanceof J) g =
                    Eb(g); else if ("style" == f.toLowerCase()) {
                    e = void 0;
                    ...
                    if (f.toLowerCase() in Yb) if (g instanceof K) g = Gb(g); else if (g instanceof L) g = Ib(g); else if (l(g)) g = Kb(g).j(); else throw Error('Attribute "' + f + '" on tag "div" requires goog.html.SafeUrl, goog.string.Const, or string, value "' + g + '" given.');
                }
                g.o && (g = g.j());
                f = f + '="' + t(String(g)) + '"';
                d += " " + f
    ...
    V.prototype.ja = function () {
        ...
        if ("none" != (b || (a.currentStyle ? a.currentStyle.display : null) || a.style && a.style.display)) Gc(a); else {
            b = a.style;
...
*/
    ...
    if (ha) ha(W, X); else for (var Y in X) if ("prototype" != Y) if (Object.defineProperties) {
    ...
    function Xc(a) {
        if (a.N && a.N.length) {
            ...
            Array.prototype.forEach.call(a.N, function (a) {
                if (b) {
                    var c = Oc(uc, {time: b}), d = a.querySelector(".time-remaining");
    ...
    function Sc(a) {
        ...
        if (a.hasAttribute("selected")) {
            if (b = parseInt(a.getAttribute("selected"), 0), b = Math.min(Math.max(0, parseInt(b, 10)), a.c.length - 1), a.h !== b && !isNaN(b)) {
                ...
                if (-1 === a.h) a.c[b].setAttribute("selected", ""); else {
                    a.D && Kc(a.D);
                    a.F && Kc(a.F);
                    xb(a.O);
                    c = {};
                    var d = {}, e = a.c[b], f = a.c[a.h];
                    ...
                    var g = [{ka: "transform", duration: .5, ea: 0, timing: "cubic-bezier(0.4, 0, 0.2, 1)"}];
                    a.D = new V(e, .5, c, {transform: "translate3d(0, 0, 0)"}, g);
                    a.F = new V(f, .5, {transform: "translate3d(0, 0, 0)"}, d, g);
                    Jc(a.D);
                    Jc(a.F);
                    vb(a.O, a.D, function () {
                ...
                a.h =
                    b;
                a.w && a.A && a.I && (0 === b ? a.A.setAttribute("disappear", "") : a.A.removeAttribute("disappear"), b === a.c.length - 1 ? (a.w.setAttribute("hidden", ""), a.I.removeAttribute("hidden"), Z(a, "google-codelab-action", {category: "codelab", action: "complete", label: a.s})) : (a.w.removeAttribute("hidden"), a.I.setAttribute("hidden", "")));
    ...
    function Zc(a) {
        var b = a.getAttribute("feedback-link"), c = a.c.map(function (a) {
            return a.getAttribute("label")
        });
        Lc(a.f, vc, {steps: c, fa: b});
        (b = a.f.querySelector("#codelab-feedback")) && H(a.i, b, "click", function () {
            "userfeedback" in window && window.userfeedback.api.startFeedback({productId: "5143948"})
        })
    }
