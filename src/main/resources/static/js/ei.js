!function (e) {
    ...
    }, r.p = "https://cpwebassets.codepen.io/assets/packs/", r(r.s = 684)
}({
    684: function (e, t, r) {
        "use strict";
        r.r(t);
        var n = {
            _HTML_TYPES: ["html", "xml", "haml", "markdown", "slim", "pug", "application/x-slim"], _CSS_TYPES: ["css", "less", "scss", "sass", "stylus", "postcss", "text/css", "text/x-sass", "text/x-scss", "text/x-less", "text/x-styl"], _JS_TYPES: ["js", "javascript", "coffeescript", "livescript", "typescript", "babel", "text/javascript", "text/x-coffeescript", "text/x-livescript", "text/typescript"], _CUSTOM_EDITOR_TYPES: {vue: "js", flutter: "js"}, cmModeToType: function (e) {
            ...
            var r = _("form", {class: "cp_embed_form", style: "display: none;", method: "post", action: c(e), target: e.name});
            ...
            var n = {allowfullscreen: "true", allowpaymentrequest: "true", allowTransparency: "true", class: "cp_embed_iframe " + (e.class ? e.class : ""), frameborder: "0", height: m(e), width: "100%", name: e.name || "CodePen Embed", scrolling: "no", src: r, style: "width: 100%; overflow:hidden; display:block;", title: t};
